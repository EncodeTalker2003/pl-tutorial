...
```k
  syntax priority @__FUN-LETSTAR-COMMON
                > apply
                > arith
                > _:=__FUN-LETSTAR-COMMON
                > let_in__FUN-LETSTAR-COMMON
                  letrec_in__FUN-LETSTAR-COMMON
                  if_then_else__FUN-LETSTAR-COMMON
                > _;__FUN-LETSTAR-COMMON
                > fun__FUN-LETSTAR-COMMON
                > datatype_=___FUN-LETSTAR-COMMON
endmodule

module FUN-LETSTAR-MACROS
  imports FUN-LETSTAR-COMMON
```

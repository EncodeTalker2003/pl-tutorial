...
```k
  syntax Exp ::= Int | Bool | String | Name | "read"
               | "(" Exp ")"                       [bracket]
...
```k
  syntax priority @__FUN-IO-COMMON
                > apply
				// > print__FUN-IO-COMMON
                > arith
                > _:=__FUN-IO-COMMON
                > let_in__FUN-IO-COMMON
                  letrec_in__FUN-IO-COMMON
                  if_then_else__FUN-IO-COMMON
                > _;__FUN-IO-COMMON
                > fun__FUN-IO-COMMON
                > datatype_=___FUN-IO-COMMON
endmodule

module FUN-IO-MACROS
  imports FUN-IO-COMMON
```
